...
- [Comparing to the pure runtime checkers](#comparing-to-the-pure-runtime-checkers)
  - [is over 100 times faster](#generator-produces-code-that-is-over-100-times-faster)
  - [does not have any runtime dependencies](#generator-does-not-have-any-runtime-dependencies)
  - [produced TypeScript code is strictly type-safe](#generator-produces-typescript-code-that-is-strictly-type-safe)
  - [produced code that is readable and modifiable](#generator-produces-code-that-is-readable-and-modifiable)
  - [does not require a custom DSL](#generator-does-not-require-defining-types-using-a-custom-dsl)
  - [produced code is faster to cold start](#generator-produces-code-that-is-way-faster-to-cold-start)
  - [does not use `eval()`](#generator-does-not-use-eval)
  ...
  - [the produced code is easy to review](#generator-produces-code-that-is-easy-to-review)
- [Comparing to TypeScript compiler plugins](#comparing-to-typescript-compiler-plugins)
  - [does not require `tsc` plugins](#generator-does-not-require-tsc-plugins)
  - [produces type-safe TypeScript](#generator-produces-type-safe-typescript)
  - [produced code that is readable and modifiable](#generator-code-is-explicitly-readable-and-modifiable)
  - [produces shareable code across project boundaries](#generator-code-shareable-across-project-boundaries)
  - [emitted code is easy to debug](#generator-emitted-code-is-easy-to-debug)
  - [supports all the JS/TS tools](#generator-supports-all-the-jsts-tools)
- [Comparing to the other code generators](#comparing-to-the-other-code-generators)
  - [produces type-safe TS](#generator-produces-type-safe-ts)
  - [produces readable code](#generator-produces-readable-code)
  - [always produces correct code](#generator-always-produces-correct-code)
  - [produces even faster code](#generator-code-is-fast)
  - [also emits unit tests](#generator-also-tests-the-generated-code)
- [Better than ChatGPT](#is-it-better-than-chatgpt)
- [Summary](#summary)
